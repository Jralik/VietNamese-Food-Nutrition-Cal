...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # ONNX Runtime
            ...
            import onnxruntime
            has_cuda_provider = cuda and "CUDAExecutionProvider" in onnxruntime.get_available_providers()
            providers = ["CUDAExecutionProvider", "CPUExecutionProvider"] if has_cuda_provider else ["CPUExecutionProvider"]
